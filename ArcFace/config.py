...
dataset.casia.dataset_path = 'datasets/casia'
...
# dataset = edict()
# dataset.new = edict()
# dataset.new.dataset = 'casia'
# dataset.new.dataset_path = '/datasets/new'
# dataset.new.num_classes = 10572
# dataset.new.image_shape = (112, 112, 3)
# dataset.new.val_targets = ['lfw', 'cfp_fp', 'agedb_30']

# dataset.emore = edict()
# dataset.emore.dataset = 'emore'
# dataset.emore.dataset_path = '/data/recognition/datasets/faces_emore'
# dataset.emore.num_classes = 10572
